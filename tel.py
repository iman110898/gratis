...
def main():
    print(colors('\n'.join([
        '',
        '[CC]''[G1]       *SELAMAT DATANG*',
        '[CC]''[G1]*DI DUNIA BAWAH TANAH INTERNET*',
        '[CC]''[G1]     *INTERNET  GRATIS*',
        '',
        '[P1]        -o            o-        ', '[CC]'
        '[P1]         +mMMMMMMMMMMm+         ', '[CC]'
        '[P1]       +mMMMMMMMMMMMMMMm+       ', '[CC]'
        '[P1]      /dM| |NMMMMMMN| |Md\      ', '[CC]'
        '[P1]      hMMMMMMMMMMMMMMMMMMY      ', '[CC]'
        '[P1]  ..  ====================  ..  ', '[CC]'
        '[P1].mMMm/MMMMMMMMMMMMMMMMMMMM\mMMm.', '[CC]'
        '[P1]:mMMm-MMMMMMMMMMMMMMMMMMMM-mMMm:', '[CC]'
        '[P1]:mMMm-MMMMMMMMMMMMMMMMMMMM-mMMm:', '[CC]'
        '[P1]:mMMm-MMMMMMMMMMMMMMMMMMMM-mMMm:', '[CC]'
        '[P1]:mMMm-MMMMMMMMMMMMMMMMMMMM-mMMm:', '[CC]'
        '[P1]:mMMm-MMMMMMMMMMMMMMMMMMMM-mMMm:', '[CC]'
        '[P1] +yy+ MMMMMMMMMMMMMMMMMMMM +yy+ ', '[CC]'
        '[P1]      mMMMMMMMMMMMMMMMMMMm      ', '[CC]'
        '[P1]      \\++MMMMh++hMMMM++//      ', '[CC]'
        '[P1]          MMMMo  oMMMM          ', '[CC]'
        '[P1]          MMMMo  oMMMM          ', '[CC]'
        '[P1]          MMMMo  oMMMM          ', '[CC]'
        ...
        '',
        '[CC]'
        '[R1]Script by DINI NUR IMAN', '[CC]'
        '[P1]No Whatsapp : +682192290382', '[CC]'
        '[P1]Instagram   : @d.n.i98', '[CC]'
        '',
        '[P1]PERGUNAKAN DENGAN BIJAK ', '[CC]'
        '[G1]JANGAN SHARE KE MEDIA SOSIAL ', '[CC]'
        '',
        '',
        '[G1]           ADES CYBER',
        '',
        '',
        '   Tidak ada System Yang kuat',
        '          di tangan kami',
        '',
    ])))
